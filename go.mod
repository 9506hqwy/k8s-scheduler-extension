module github.com/9506hqwy/k8s-scheduler-extension
...
require (
	...
	k8s.io/kube-scheduler v0.33.12
...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.33.12
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.33.12
	k8s.io/kubernetes => k8s.io/kubernetes v1.33.12
